...
create procedure [dbo].[AddNewPost](
	...
	as
begin
	insert into Posts (CategoryID, PostTitle, PostDate, PostContent, Author, PostStatus, IsStickyPost)
	values (@CategoryID, @PostTitle, @PostDate, @PostContent, @Author, @PostStatus, @IsStickyPost)
